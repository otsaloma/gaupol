...
:var RUNNING_SPHINX: ``True`` if generating API documentation with sphinx
   ...
   `RUNNING_SPHINX` allows one to conditially do some funky things to ensure
   that autogenerated API documentation is correct, while also avoiding that
   funk during normal use of aeidon or gaupol.
