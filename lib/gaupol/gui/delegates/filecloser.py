...
class FileCloser(Delegate):
    ...
    def _close_project(self, project):
        ...
        # Dummy page-switch to update GUI properties.
        page = self.notebook.get_current_page()
        self.on_notebook_page_switched(self.notebook, 'pointer', page)
    ...
    def on_close_all_activated(self, *args):
        ...
        if unsaved_count == 1:
            self.on_close_activated(unsaved_prj) 
    ...
    def on_quit_activated(self, *args):
        ...
        success = self.on_close_all_activated()
        if not success:
            return False
