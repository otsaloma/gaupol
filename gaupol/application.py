...
class Application(aeidon.Observable, gaupol.Runner):
    ...
    See gaupol.agents for application methods provided by agents.
    """
    ...
    def _init_main_toolbar(self, vbox):
        ...
        gaupol.conf.connect(self, "application_window", "toolbar_style")
    ...
    def _init_visibilities(self):
        ...
        visible = gaupol.conf.application_window.show_main_toolbar
        toolbar = self.uim.get_widget("/ui/main_toolbar")
        toolbar.props.visible = visible
        visible = gaupol.conf.application_window.show_video_toolbar
        self.video_toolbar.props.visible = visible
        visible = gaupol.conf.application_window.show_statusbar
    ...
    def _init_window(self):
        ...
        self.window.set_icon_name("aeidon")
        gtk.window_set_default_icon_name("aeidon")
