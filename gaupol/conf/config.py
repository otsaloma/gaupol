...
class Config(configobj.ConfigObj):
    ...
    def __init__(self, config_file, spec_file, print_unrecognized=True):
        ...
        try:
            ...
            aeidon.util.print_read_io(sys.exc_info(), config_file)
            configobj.ConfigObj.__init__(
            ...
            raise gaupol.ConfigParseError(obj)
    ...
    def write_to_file(self):
        ...
        try:
            aeidon.util.makedirs(os.path.dirname(self.filename))
            configobj.ConfigObj.write(self)
        except (IOError, OSError):
            aeidon.util.print_write_io(sys.exc_info(), self.filename)
        except UnicodeError:
