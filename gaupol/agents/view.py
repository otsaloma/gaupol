...
class ViewAgent(aeidon.Delegate):
    ...
    @aeidon.deco.export
    def _on_set_framerate_activate(self, action, param):
        """Change the framerate to use."""
        print("TODO: _on_set_framerate_activate")
    ...
    def _on_set_layout_activate(self, action, parameter):
        ...
        print("TODO: _on_set_layout_activate")
    ...
    @aeidon.deco.export
    def _on_set_position_units_activate(self, *args):
        """Change the units in which positions are shown."""
        print("TODO: _on_set_position_units_activate")
        # page = self.get_current_page()
    ...
    def _on_toggle_main_toolbar_activate(self, *args):
        ...
        print("TODO: _on_toggle_main_toolbar_activate")
    ...
    def _on_toggle_player_activate(self, *args):
        ...
        print("TODO: _on_toggle_player_activate")
    ...
    def _on_view_header_button_press_event(self, button, event):
        ...
        print("TODO: _on_view_header_button_press_event")
