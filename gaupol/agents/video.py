...
class VideoAgent(aeidon.Delegate):
    ...
    def _init_player_widgets(self):
        ...
        hbox = gaupol.util.new_hbox(spacing=12)
        gaupol.util.pack_start(hbox, self.player_toolbar)
        gaupol.util.pack_start_expand(hbox, self.seekbar)
        gaupol.util.pack_start_fill(vbox, hbox)
