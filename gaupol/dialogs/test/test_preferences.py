...
class Test_EditorPage(gaupol.TestCase):
...
class Test_ExtensionPage(gaupol.TestCase):
...
class Test_FilePage(gaupol.TestCase):
...
class Test_PreviewPage(gaupol.TestCase):
