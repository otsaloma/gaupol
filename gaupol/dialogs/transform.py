...
class _PositionTransformDialog(gaupol.GladeDialog):
    ...
    def __init__(self, parent, application):
        ...
        gaupol.GladeDialog.__init__(self, "transform.glade")
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_preview_button_1", "clicked")
        aeidon.util.connect(self, "_preview_button_2", "clicked")
        aeidon.util.connect(self, "_subtitle_spin_1", "value-changed")
        aeidon.util.connect(self, "_subtitle_spin_2", "value-changed")
