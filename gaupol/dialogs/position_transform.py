...
class FrameTransformDialog(PositionTransformDialog):
    ...
    def _init_widgets(self):
        ...
        gaupol.util.pack_start_expand(self._correction_hbox_1, self.output_spin_1)
        gaupol.util.pack_start_expand(self._correction_hbox_2, self.output_spin_2)
...
class TimeTransformDialog(PositionTransformDialog):
    ...
    def _init_widgets(self):
        ...
        gaupol.util.pack_start_expand(self._correction_hbox_1, self.output_entry_1)
        gaupol.util.pack_start_expand(self._correction_hbox_2, self.output_entry_2)
        self._correction_hbox_1.show_all()
        self._correction_hbox_2.show_all()
