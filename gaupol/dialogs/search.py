...
class SearchDialog(gaupol.GladeDialog):
    ...
    def __init__(self, application):
        ...
        gaupol.GladeDialog.__init__(self, "search.glade")
    ...
    def _init_dialog_handlers(self):
        ...
        aeidon.util.connect(self, self, "show")

    def _init_search_handlers(self):
        """Initialize search signal handlers."""

        aeidon.util.connect(self, "_next_button", "clicked")
        aeidon.util.connect(self, "_pattern_entry", "changed")
        aeidon.util.connect(self, "_previous_button", "clicked")
        aeidon.util.connect(self, "_regex_check", "toggled")
        aeidon.util.connect(self, "_replace_all_button", "clicked")
        aeidon.util.connect(self, "_replace_button", "clicked")
        aeidon.util.connect(self, "_text_view", "focus-out-event")
        aeidon.util.connect(self, "_ignore_case_check", "toggled")
    ...
    def _update_search_targets(self):
        ...
        for page in self.application.pages:
            translate = gaupol.util.text_field_to_document
            docs = [translate(x) for x in self.conf.fields]
            wrap = (self.conf.target != gaupol.targets.ALL)
    ...
    def _write_history(self, name):
        ...
        directory = os.path.join(aeidon.CONFIG_HOME_DIR, "search")
        aeidon.deco.silent(OSError)(aeidon.util.makedirs)(directory)
