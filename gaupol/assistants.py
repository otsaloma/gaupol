...
class _GladePage(TextAssistantPage):
    ...
    def __init__(self, assistant, glade_basename):
        ...
        self._glade_xml = gaupol.util.get_glade_xml(*parts)
...
class _LocalePage(_GladePage):
    ...
    def _init_country_combo(self):
        ...
        items = [(x, aeidon.countries.code_to_name(x)) for x in codes]
    ...
    def _init_language_combo(self):
        ...
        items = [(x, aeidon.languages.code_to_name(x)) for x in codes]
        items.sort(key=lambda x: x[1])
    ...
    def _init_script_combo(self):
        ...
        items = [(x, aeidon.scripts.code_to_name(x)) for x in codes]
        items.sort(key=lambda x: x[1])
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_country_combo", "changed")
        aeidon.util.connect(self, "_language_combo", "changed")
        aeidon.util.connect(self, "_script_combo", "changed")
...
class _CommonErrorPage(_LocalePage):
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_human_check", "toggled")
        aeidon.util.connect(self, "_ocr_check", "toggled")
...
class _JoinSplitWordsPage(_GladePage):
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_language_button", "clicked")
        aeidon.util.connect(self, "_join_check", "toggled")
        aeidon.util.connect(self, "_split_check", "toggled")
    ...
    def _on_join_check_toggled(self, check_button, *args):
        ...
        gaupol.conf.join_split_words.join = active
    ...
    def _on_split_check_toggled(self, check_button, *args):
        ...
        active = check_button.get_active()
        gaupol.conf.join_split_words.split = active
...
class _LineBreakPage(_LocalePage):
    ...
    def correct_texts(self, project, indices, doc):
        ...
        project.break_lines(
            ...
            gaupol.ruler.get_length_function(self.conf.length_unit),
...
class _LineBreakOptionsPage(_GladePage):
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_max_length_spin", "value-changed")
        aeidon.util.connect(self, "_max_lines_spin", "value-changed")
        aeidon.util.connect(self, "_max_skip_length_spin", "value-changed")
        aeidon.util.connect(self, "_max_skip_lines_spin", "value-changed")
        aeidon.util.connect(self, "_skip_length_check", "toggled")
        aeidon.util.connect(self, "_skip_lines_check", "toggled")
        aeidon.util.connect(self, "_skip_unit_combo", "changed")
        aeidon.util.connect(self, "_unit_combo", "changed")
...
class _ConfirmationPage(_GladePage):
    ...
    def _init_signal_handlers(self):
        ...
        aeidon.util.connect(self, "_mark_all_button", "clicked")
        aeidon.util.connect(self, "_preview_button", "clicked")
        aeidon.util.connect(self, "_remove_check", "toggled")
        aeidon.util.connect(self, "_unmark_all_button", "clicked")
