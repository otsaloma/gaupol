"""
Toggle translation text column: activating should flip the visibility of
the translation text column and update the visible-fields config accordingly.
...
def setup(application):
    ...
    column = page.view.get_column(page.view.columns.TRAN_TEXT)
...
def verify(application):
    ...
    try:
        ...
        present = gaupol.fields.TRAN_TEXT in gaupol.conf.editor.visible_fields
        assert present != (gaupol.fields.TRAN_TEXT in _fields_before)
    finally:
