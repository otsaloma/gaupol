"""
Save main document: with an unsaved change, saving in place should write
the file and clear the changed flag. No dialog appears since the main file
already has a path and encoding.
