"""
Toggle start column: activating should flip the visibility of the start
...
def setup(application):
    ...
    column = page.view.get_column(page.view.columns.START)
...
def verify(application):
    ...
    try:
        ...
        present = gaupol.fields.START in gaupol.conf.editor.visible_fields
        assert present != (gaupol.fields.START in _fields_before)
    finally:
